				...
				<section className={styles.checkout}>
					<div>
						<Heading className='mb-4'>
							Для заказа сделайте скриншот вашей корзины и отправьте его на
							email компании
						</Heading>
						...
						<div className={styles.footer}>
							...
							<Link className='mt-5 mb-2' href='/contacts'>
								<h1>Заказать</h1>
							</Link>
						</div>
					</div>
					<div>
						<Heading className='mb-6 text-2xl'>Рекомендуем:</Heading>
